/* =========================================================
   ...
   背景そのものは今後変更しない。
   家具追加・修理・設備復旧・バリケードなどは
   deco002、deco003... で上から追加していく。
========================================================= */
...
export const homeDeco001 = {
  ...
  /* =======================================================
     ...
     通常HOME画面でのNPC配置。
     実際の表示・非表示はhome-loader.js側で制御する。
  ...
  /* =======================================================
     ...
     action.type はhome-loader.jsで処理する。
  ======================================================= */
